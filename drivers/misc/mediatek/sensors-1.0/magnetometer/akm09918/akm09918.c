...
static const struct of_device_id mag_of_match[] = {
	//modify OSODEV-1176 by haiping.bai 20171124 start
	{.compatible = "mediatek,msensor_akm09918"},
	{},
	//modify OSODEV-1176 by haiping.bai 20171124 end
};
#endif
...
int FctShipmntTestProcess_Body(void)
{
	...
	/* Step 1 to 2 */
	/* *********************************************** */
//modify CAQGHLSS-1 by jixiaopan 20171124 start
#if defined(CONFIG_AKM_DEVICE_AKM09911)
//modify CAQGHLSS-1 by jixiaopan 20171124 end
	pf_total = FST_AK09911();
//modify CAQGHLSS-1 by jixiaopan 20171124 start
#elif defined(CONFIG_AKM_DEVICE_AKM09916)
//modify CAQGHLSS-1 by jixiaopan 20171124 end
...
static int akm09918_factory_get_data(int32_t data[3], int *status)
{
	...
	ret =  akm09918_get_data(&data[0], &data[1], &data[2], status);
        //modify CAQGHLSS-1 by jixiaopan 20171124 start
        data[0] = data[0]*3/CONVERT_M_DIV/20;
        data[1] = data[1]*3/CONVERT_M_DIV/20;
        data[2] = data[2]*3/CONVERT_M_DIV/20;
        //modify CAQGHLSS-1 by jixiaopan 20171124 end
	return 0;
}
