 ...
 *
 * $Revision: 15504 $
 * $Date: 2017-08-16 11:11:40 +0800 (周三, 16 八月 2017) $
 *
...
#if NVT_DEBUG
#define NVT_DEBUG_EN(fmt, args...)    pr_info("[%s] %s %d: " fmt, NVT_I2C_NAME, __func__, __LINE__, ##args)
...
#define LEATHER_MODE 1
#if LEATHER_MODE
#define NVT_PROC_LEATHER_FILE     "gtp_leather_mode"
#endif
...
#define TCL_BOOT_UPDATE_FIRMWARE_NAME "novatek_ts_fw.bin"
#define DJN_BOOT_UPDATE_FIRMWARE_NAME "novatek_ts_djn_fw.bin"
