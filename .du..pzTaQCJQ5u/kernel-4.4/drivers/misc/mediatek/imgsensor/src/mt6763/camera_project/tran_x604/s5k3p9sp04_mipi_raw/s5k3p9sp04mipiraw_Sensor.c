...
#include "s5k3p9sp04mipiraw_Sensor_setting.h"
#include "s5k3p9sp04mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9SP04_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			if(*sensor_id  == 0x3109)
			{
				if(flag_cam == 11){
					*sensor_id = 0x310d;
					printk("s5k3p9sp04 yazhou_debug flag_cam = %d , *sensor_id = %x\n",flag_cam,*sensor_id);
				}else{
					*sensor_id = 0x310c;
					printk("s5k3p9sp04  yazhou_debug flag_cam = %d , *sensor_id = %x\n",flag_cam,*sensor_id);
				}
			...
			#endif
			printk("s5k3p9sp04 moduelID read:0x%x\n",moduelID);
			//modify XLLSHLSS-370 by ming.liao 20180201 end
                             ...
                             UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	/******************** PDAF START >>> *********/
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			/* S5K3p9SP04_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2))); */
			break;
	/******************** PDAF END   <<< *********/
	default:
	    break;
...
UINT32 S5K3p9SP04_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	S5K3p9SP04_MIPI_RAW_SensorInit	*/
