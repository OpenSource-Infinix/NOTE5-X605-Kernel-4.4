...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	...
	},
	{
		...
		{
			{IMGSENSOR_HW_ID_MCLK,      IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_GPIO,      IMGSENSOR_HW_PIN_AVDD}, //modify by ming.liao@reallytek.com for X604 camera 20171124
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DVDD}, //modify by ming.liao@reallytek.com for X604 camera 20171124
			{IMGSENSOR_HW_ID_GPIO,      IMGSENSOR_HW_PIN_PDN},
			{IMGSENSOR_HW_ID_GPIO,      IMGSENSOR_HW_PIN_RST},
...
#if defined(OV12A10B_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV12A10B_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#endif
#if defined(S5K3P9SP04B_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9SP04B_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
