...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_AVDD},//modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116 
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DVDD},
			//{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AFVDD},//modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116 
	...
	},
	{
		...
		{
			{IMGSENSOR_HW_ID_MCLK,      IMGSENSOR_HW_PIN_MCLK},
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_AVDD}, //modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116
			{IMGSENSOR_HW_ID_REGULATOR, IMGSENSOR_HW_PIN_DOVDD},
			{IMGSENSOR_HW_ID_GPIO, IMGSENSOR_HW_PIN_DVDD}, //modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116
			{IMGSENSOR_HW_ID_GPIO,      IMGSENSOR_HW_PIN_PDN},
			{IMGSENSOR_HW_ID_GPIO,      IMGSENSOR_HW_PIN_RST},
			#ifdef MIPI_SWITCH /*add by ming.liao@reallytek.com for X604 camera 20171124 start */
			{IMGSENSOR_HW_ID_MT6306,      IMGSENSOR_HW_PIN_MIPI_SWITCH_EN},
			{IMGSENSOR_HW_ID_MT6306,      IMGSENSOR_HW_PIN_MIPI_SWITCH_SEL},
			#endif             /*add by ming.liao@reallytek.com for X604 camera 20171124 end */
			{IMGSENSOR_HW_ID_NONE,      IMGSENSOR_HW_PIN_NONE},
		},
	},
	{
...
#endif
//add by ming.liao@reallytek.com for X604 camera 20171124 start
...
#endif
#if defined(S5K3P9B_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K3P9B_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#if defined(OV12A10_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV12A10_MIPI_RAW,
		{
			...
			{AVDD, Vol_2800, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},//modify power by ming.liao 20171220
			{PDN, Vol_High, 1},
			{RST, Vol_High, 1}
		},
	},
#endif
//add by ming.liao@reallytek.com for X604 camera 20171124 end
//modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116 start
...
#endif
#if defined(S5K2P7B_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K2P7B_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
...
#endif
//modify XLLWHLSE-4 bring up camera sensor in x605 by luyan.ye 20180116 end
