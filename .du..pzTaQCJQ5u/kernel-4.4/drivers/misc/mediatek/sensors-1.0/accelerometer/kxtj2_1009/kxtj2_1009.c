...
static const struct of_device_id accel_of_match[] = {
	{.compatible = "mediatek,gsensor_kxtj2_1009"},
	{},
};
#endif
        ...
        case COMPAT_GSENSOR_IOCTL_READ_SENSORDATA:
            if (arg32 == NULL)
            {
                ...
                break;
                    ...
                    if (err){
                        GSE_ERR("kxtj2_1009 GSENSOR_IOCTL_READ_SENSORDATA unlocked_ioctl failed.");
                        return err;
                    }
        break;
...
/*----------------------------------------------------------------------------*/
//add CAQGHLSS-188 by jixiaopan 20171207 end
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
