...
void Boot_Update_Firmware(struct work_struct *work)
{
	...
	{
		sprintf(firmware_name, TCL_BOOT_UPDATE_FIRMWARE_NAME);
	}
	if ((strcmp(lcm_name, "nt36672_fhdp_dsi_vdo_djn_jdi_x604")) == 0)
	{
		sprintf(firmware_name, DJN_BOOT_UPDATE_FIRMWARE_NAME);
	}
