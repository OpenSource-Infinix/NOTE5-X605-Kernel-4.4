...
static int msdc_ops_get_cd(struct mmc_host *mmc)
{
	...
	//modify XLLSHLSS-2901 by peixuan.qiu 20180428 start
	printk("Card insert<%d> Block bad card<%d>, mrq<%p> claimed<%d> pwrcnt<%d>",
		host->card_inserted,
		host->block_bad_card,
		host->mrq, mmc->claimed,
		host->power_cycle_cnt);
	//modify XLLSHLSS-2901 by peixuan.qiu 20180428 end
